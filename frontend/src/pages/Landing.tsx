...
const MockTextTile = ({
    ...
    <TileShell
        className={`p-2 flex flex-col gap-2 ${className ?? 'w-[220px]'}`}
    >
...
const MockImageTile = ({
    ...
    <TileShell className={small ? 'w-[200px]' : 'w-[280px]'}>
        <img
            src={src}
            alt=""
            className={`w-full object-cover ${small ? 'h-[130px]' : 'h-[180px]'}`}
        />
...
const MockLinkTile = ({
    ...
    <TileShell className="w-[260px] flex flex-col gap-0">
        {thumbnail && (
            <img
                src={thumbnail}
                alt=""
...
const BOARDS = [
    {
        title: 'Tokyo Architecture',
        emoji: '🏯',
        description: 'Brutalist icons, capsule towers, and titanium spheres.',
        img: 'https://res.cloudinary.com/dzwjyg2ai/image/upload/w_600,f_auto,q_auto/v1771518162/IMP_Resources/pexels-photo-5544961_bbsgqw.jpg',
    },
    {
        title: 'Japan Travel',
        emoji: '✈️',
        description: 'Airbnbs, hidden chapels, and must-visit landmarks.',
        img: 'https://res.cloudinary.com/dzwjyg2ai/image/upload/w_600,f_auto,q_auto/v1771518160/IMP_Resources/2b0f280b-42be-4cac-9eae-9c3281a256c2_yspeiz.avif',
    },
    {
        title: 'Sacred Geometry',
        emoji: '🎋',
        description: 'Spiraling staircases and impossible structures.',
        img: 'https://res.cloudinary.com/dzwjyg2ai/image/upload/w_600,f_auto,q_auto/v1771518161/IMP_Resources/Bella-vista201512-02_nmlhb4.jpg',
    },
    {
        title: 'Modern Icons',
        emoji: '🌐',
        description: 'Bold civic architecture from the last 30 years.',
        img: 'https://res.cloudinary.com/dzwjyg2ai/image/upload/w_600,f_auto,q_auto/v1771518161/IMP_Resources/2018_FCG_Headquarters_Building_2_tcg9wi.jpg',
    },
    {
        title: 'Art & Culture',
        emoji: '🎨',
        description: 'Design-forward galleries and cultural centres.',
        img: 'https://res.cloudinary.com/dzwjyg2ai/image/upload/w_600,f_auto,q_auto/v1771518161/IMP_Resources/photo_2023-12-14_13-.jpg_jhs6wa.webp',
    },
];
            ...
            <div className="overflow-hidden" ref={emblaRef}>
                <div className="flex">
                    {BOARDS.map((board) => (
                        <div
                            key={board.title}
                            className="shrink-0 w-[280px] pl-4 min-w-0"
                        >
                            <Card className="overflow-hidden gap-0 py-0 w-full">
                                <img
                                    src={board.img}
                                    alt={board.title}
...
export default function Landing() {
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <MockTextTile
                        className="w-[520px]"
                        title="Must Visit! 📍"
                        body="Two architectural icons, 15 min apart — the National Art Center's rippling glass facade (Kurokawa, 2007) and Fuji TV's titanium sphere floating above Odaiba (Tange, 1997). Budget at least half a day for both."
                    />
                </div>
                ...
                <div
                    className="mock-tile opacity-0 absolute"
                    style={{ bottom: '10%', right: '8%', zIndex: 2 }}
                >
                    <MockImageTile
                        small
                ...
                <div
                    ref={containerRef}
                    className="relative overflow-hidden z-10 border-2 border-black"
                    style={{
                        width: '320px',
                        height: '240px',
            ...
            <section
                ref={bentoRef}
                className="relative w-full py-20 px-6 bg-background overflow-hidden"
                style={{
                    backgroundImage:
                        'radial-gradient(circle, oklch(0% 0 0 / 0.12) 1.5px, transparent 1.5px), radial-gradient(circle, oklch(0% 0 0 / 0.12) 1.5px, transparent 1.5px)',
            ...
            {/* Carousel section */}
            <section className="relative w-full py-20 px-6 overflow-hidden bg-background grid-pattern">
                <TemplateCarousel />
            </section>
            <Footer />
        </>
